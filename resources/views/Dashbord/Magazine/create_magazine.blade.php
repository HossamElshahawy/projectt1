            ...
            <div class="card-body">
                <div class="row">
                    <form method="POST" action="{{route('magazine.create.handle')}}" enctype="multipart/form-data">
                        ...
                        <div class="col-xl-4 col-md-6 col-12">
                            <div class="mb-1">
                                ...
                                <input type="text" class="form-control font" id="basicInput"
                                       placeholder="مثل'المجله اليوميه من انا مهندس'" name="title">
                            </div>
                        </div>
                        <div class="mb-1">
                        ...
                        <div class="mb-1">
                            <label class="form-label font" for="basicInput">desc</label>
                            <input type="text" class="form-control font" id="basicInput"
                                   placeholder="مثل الهندسه المدنيه" name="min_description">
                        </div>
                        <label class="form-label font" for="basicInput">اختر صوره المقاله</label>
