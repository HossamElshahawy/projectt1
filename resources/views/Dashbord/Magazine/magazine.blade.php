...
<div class="app-content content ">
    ...
    <!-- END: Content-->
    <h5 class="mb-1 fontBig">المجلات </h5>


    <a href="{{route('magazine.create.page')}}"> <button type="button" class="btn btn-success waves-effect waves-float waves-light align-items-start fontSize">+
            اضف مجله</button></a>
            ...
            <div class="table-responsive">
                <table class="table font">
                    ...
                    @foreach($magazine as $Magazine)
                        <tr>
                            <td>
                                <span class="fw-bold">{{$Magazine->title}}</span>
                            </td>
                            ...
                            <td>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a class="dropdown-item" href="{{route('Magazine.page.edit', $Magazine->id)}}">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                        ...
                                        <a class="dropdown-item" href="{{route('Magazine.delete' , $Magazine->id)}}">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                                 viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                 stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
