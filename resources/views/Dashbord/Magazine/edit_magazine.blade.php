...
<div class="app-content content ">
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <form method="POST" action="{{route('Magazine.edit',$magazine->id)}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-1">
                            ...
                            <textarea class="form-control font" id="mytextarea" rows="3"
                                      name="description"  >{{old('description') ?? $magazine->description}}</textarea>
                        </div>

                        <label class="form-label font" for="basicInput">اختر صوره للمجله</label>
                        <div class="input-group mb-3 color">
                            <label class="input-group-text font color" for="inputGroupFile01">اختر</label>
                            <input class="form-control color" id="inputGroupFile01" type="file" name="photo" >
                            <img src="/storage/magazine/{{$magazine->photo}}" alt="img" class="gallery-thumb-img" style="height: 300px; width: 100%">
                        ...
                        <div class="col-xl-4 col-md-6 col-sm-12 mb-2 font">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="text" class="form-control phone-number-mask" placeholder=" " name="link" value="{{old('link') ?? $magazine->link}}" >
                            </div>
                        </div>
            ...
            <div class="col-xl-4 col-md-6 col-12 font">
               ...
               <a> <button  herf="{{route('magazine.create.page')}}" type="button" class="btn btn-warning waves-effect waves-float waves-light font">انشاء مجله جديد</button></a>
            </div>
