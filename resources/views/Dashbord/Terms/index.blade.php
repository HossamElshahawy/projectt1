...
<div class="app-content content ">
    ...
    <!-- END: Content-->
    <h5 class="mb-1 fontBig">الشروط والاحكام </h5>


    <a href="{{route('terms.create')}}"> <button type="button" class="btn btn-success waves-effect waves-float waves-light align-items-start fontSize">+
            اضف </button></a>
                            ...
                            <td>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a class="dropdown-item" href="{{route('terms.edit',$term->id)}}">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                        ...
                                        <form action="{{route('terms.destroy', $term->id)}}" class="d-inline-block" method="post" >
                                            @csrf
                                            @method('delete')
