...
<div class="app-content content ">
    ...
    <!-- END: Content-->
    <h5 class="mb-1 fontBig">المستخدمين </h5>


    <a href="{{route('user.create')}}"> <button type="button" class="btn btn-success waves-effect waves-float waves-light align-items-start fontSize">+
            اضف مستخدم</button></a>
