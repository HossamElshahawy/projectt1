...
<head>
    ...
    <title> انا مهندس - لوحه التحكم| الاقسام </title>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end font">
                                            <a class="dropdown-item" href="{{route('parts.edit',$Category->id)}}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                            ...
                                            <a class="dropdown-item font" href="{{route('parts.destroy',$Category->id)}}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
