            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="col-xl-4 col-md-6 col-12 font ">
                        <button class="btn btn-gradient-success font">اضف</button>
                        <a href="{{route('parts.create')}}"><button
                                class="btn btn-warning waves-effect waves-float waves-light font">انشاء قسم
                                جديد</button></a>
                    </div>
                    </form>
                </div>
