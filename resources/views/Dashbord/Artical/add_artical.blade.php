    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title font">بيانات المقاله</h4>
            </div>
            ...
            <div class="card-body">
                <form method="POST" action="{{route('article.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <label class="form-label font" for="basicInput">اختر صوره</label>
                        ...
                        <div class="mb-1">
                            <label class="form-label font" for="basicInput">شعار1</label>
                            <input type="text" class="form-control font" id="basicInput"
