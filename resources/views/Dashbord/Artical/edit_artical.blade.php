                ...
                <form method="POST" action="{{route('article.update',$article->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="input-group mb-3 color">
                            ...
                            <img src="/storage/article/{{$article->img}}" alt="img" class="gallery-thumb-img" style="height: 300px; width: 100%">

                        </div>
                        <div class="mb-1">
                            <label class="form-label font" for="basicInput">min desc</label>
                            <input type="text" class="form-control font" id="mytextarea"
                                   name="min_description"  value="{{old('min_description',$article->min_description)}}">
                        </div>
