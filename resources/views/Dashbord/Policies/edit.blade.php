            ...
            <div class="card-body">
                <form method="POST" action="{{route('policy.update',$policy->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-1">
                            <label class="form-label font" for="exampleFormControlTextarea1 ">المحتوي</label>
                            <textarea class="form-control font" id="exampleFormControlTextarea1" rows="3"
                                      name="name">{{old('name',$policy->name)}}</textarea>
                        </div>

                        <div class="mb-1">
                            <label class="form-label font" for="exampleFormControlTextarea1 ">المحتوي</label>
                            <textarea class="form-control font" id="exampleFormControlTextarea1" rows="3"
                                      name="description">{{old('description',$policy->content)}}</textarea>
                        </div>
