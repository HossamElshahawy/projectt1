...
<div class="app-content content ">
    ...
    <a href="{{route('policy.create')}}"> <button type="button" class="btn btn-success waves-effect waves-float waves-light align-items-start fontSize">+
            اضف </button></a>
                            ...
                            <td>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a class="dropdown-item" href="{{route('policy.edit',$policy->id)}}">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                        ...
                                        <form action="{{route('policy.destroy', $policy->id)}}" class="d-inline-block" method="post" >
                                            @csrf
                                            @method('delete')
