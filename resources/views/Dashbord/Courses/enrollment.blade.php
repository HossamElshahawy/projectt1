...
<!-- END: Main Menu-->
    ...
    <div class="app-content content ">
        ...
        <!-- END: Content-->
        <h5 class="mb-1 fontBig">طلبات الكورسات </h5>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a class="dropdown-item" href="{{route('enrollment.approve', [$enrollment->user_id, $enrollment->course_id])}}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                            ...
                                            <a class="dropdown-item" href="{{ route('enrollment.disapprove', [$enrollment->user_id, $enrollment->course_id]) }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
