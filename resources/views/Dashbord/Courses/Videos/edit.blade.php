                ...
                <form method="POST" action="{{route('video.update',$video->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-md-6 col-12">
                            <div class="mb-1">
                                ...
                                <input type="text" class="form-control font" id="basicInput"
                                       placeholder="مثل'الهندسه المدنيه'" name="name" value="{{old('name',$video->name)}}" >
                            </div>
                        </div>

                        {{--                        <div class="col-xl-4 col-md-6 col-12">--}}
                        {{--                            <div class="mb-1">--}}
                        {{--                                <label class="form-label font" for="basicInput">اللينك</label>--}}
                        {{--                                <input type="text" class="form-control font" id="basicInput"--}}
                        {{--                                       placeholder="مثل'الهندسه المدنيه'" name="url" >--}}
                        {{--                            </div>--}}
                        {{--                        </div>--}}
                        ...
                        <div class="col-xl-4 col-md-6 col-12">
                            <div class="mb-1">
                                ...
                                <input type="number" class="form-control font" id="basicInput"
                                       placeholder="مثل'الهندسه المدنيه'" name="order" value="{{old('order',$video->order)}}">
                            </div>
                        </div>

                        <div class="form-group row pt-6">
                            <label for="section" class="col-sm-2 col-form-label">اسم القسم</label>
                            <div class="col-sm-10">
                                <select name="section" class="custom-select">

                                    @foreach ($sections as $section)
                                        <option @if ($section->id == $video->section_id) selected @endif value="{{$section->id}}">{{$section->name}}</option>
                                    @endforeach
                        ...
                        <div class="input-group mb-3 color">
                            ...
                            <input type="file" name="videos[]" class="form-control color" id="inputGroupFile01" multiple value="{{ old('videos.*', $video->url) }}">
                        </div>
