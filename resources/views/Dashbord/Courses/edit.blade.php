      ...
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class=" nav-item fontSize"><a class="d-flex align-items-center" ><i
              ...
              <ul class="menu-content">
                  ...
                  <li><a class="d-flex align-items-center active fontSize" href="{{route('article.index')}}"><i
                              data-feather="circle"></i><span class="menu-item text-truncate"
                ...
                <form method="POST" action="{{route('course.update',$course->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="input-group mb-3 color">
                            ...
                            <img src="/storage/courses/{{$course->photo}}" alt="img" class="gallery-thumb-img" style="height: 300px; width: 100%">
                        </div>
                        ...
                        <div class="col-xl-4 col-md-6 col-sm-12 mb-2 font">
                            ...
                            <input type="text" class="form-control numeral-mask" placeholder="10,000"
                                   id="numeral-formatting" name="price_meeting" value="{{old('price_meeting',$course->price_online)}}" >
                        </div>
                        <div class="col-xl-4 col-md-6 col-sm-12 mb-2 font">
                            <label class="form-label " for="numeral-formatting">سعر الدوره اونلاين</label>
                            <input type="text" class="form-control numeral-mask" placeholder="10,000"
                                   id="numeral-formatting" name="payment_link_online" value="{{old('payment_link_online',$course->payment_link_online)}}" >
                        </div>
                        ...
                        <div class="col-xl-4 col-md-6 col-sm-12 mb-2 font">
                            ...
                            <input type="text" class="form-control numeral-mask" placeholder="10,000"
                                   id="numeral-formatting" name="price_incenter" value="{{old('price_incenter',$course->price_offline)}}" >
                        </div>
                        <div class="col-xl-4 col-md-6 col-sm-12 mb-2 font">
                            <label class="form-label " for="numeral-formatting">سعر الدوره اونلاين</label>
                            <input type="text" class="form-control numeral-mask" placeholder="10,000"
                                   id="numeral-formatting" name="payment_link_offline" value="{{old('payment_link_offline',$course->payment_link_offline)}}" >
                        </div>
                        ...
                        <div class="col-xl-4 col-md-6 col-sm-12 mb-2 font">
                            ...
                            <input type="text" class="form-control numeral-mask" placeholder="10,000"
                                   id="numeral-formatting" name="price_record" value="{{old('price_record',$course->price)}}">
                        </div>
                         <div class="col-xl-4 col-md-6 col-sm-12 mb-2 font">
                            <label class="form-label" for="numeral-formatting">سعر الدوره علي المنصه</label>
                            <input type="text" class="form-control numeral-mask" placeholder="10,000"
                                   id="numeral-formatting" name="payment_link_price" value="{{old('payment_link_price',$course->payment_link_price)}}">
                        </div>

                        <div class="mb-1">
                            <label class="form-label font" for="basicInput">وصف صغير</label>
                            <input type="text" class="form-control font"
                                   name="min_description"  value="{{old('min_description',$course->min_description)}}">
                        </div>

                        <div class="mb-1">
                            <label class="form-label font" for="basicInput">تفاصيل الدوره</label>
                            <input type="text" class="form-control font" id="mytextarea"
