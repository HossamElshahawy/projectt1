                        ...
                        <div class="inner">
                            <div class="thumbnail">
                                <a href="blog-details.html">
                                    <img src="/storage/article/category/{{$category->image}}" height="50" width="50" alt="Blog Images" >
                                </a>
                            </div>
                            <div class="content">
                                <h5 class="title"><a href="blog-details.html">{{$category->name}}</a></h5>

                                <div class="read-more-btn">
                                    <a class="edu-btn btn-border btn-medium" href="blog-details.html">اقرأ المجله <i class="icon-west"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
