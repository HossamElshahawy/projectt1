    ...
    <div class="navbar-container d-flex content">
        ...
        <ul class="nav navbar-nav align-items-center ms-auto">
                ...
                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                    ...
                    <li class="scrollable-container media-list"><a class="d-flex" href="#">
                            <div class="list-item d-flex align-items-start">
                                <div class="me-1">
                                    <div class="avatar"><img src="{{asset('dashbord/app-assets/images/portrait/small/avatar-s-15.jpg')}}" alt="avatar" width="32" height="32"></div>
                                </div>
                            ...
                            <div class="list-item d-flex align-items-start">
                                <div class="me-1">
                                    <div class="avatar"><img src="{{asset('dashbord/app-assets/images/portrait/small/avatar-s-3.jpg')}}" alt="avatar" width="32" height="32"></div>
                                </div>
            ...
            <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    </div><span class="avatar"><img class="round" src="" alt="avatar" height="40" width="40"><span class="avatar-status-online"></span></span>
                </a>
...
<div class="app-content content ">
    ...
    <div class="col-12 font">
        <ul class="nav nav-pills mb-2">
            ...
            <!-- billing and plans -->
            <li class="nav-item">
                <a class="nav-link" href="subscrption.html">
                    ...
                    <span class="fw-bold">الاشتراكات &amp; الخطط</span>
                </a>
            </li>

            <!-- connection -->
            <li class="nav-item">
                <a class="nav-link" href="social_media.html">
                    ...
                    <span class="fw-bold">التواصل الاجتماعي</span>
                </a>
            </li>
        </ul>
        <!-- profile2 -->
        ...
        <div class="card font">
            <div class="card-header border-bottom">
                <h4 class="card-title">غلق الحساب</h4>
            </div>
            <div class="card-body py-2 my-25">
                <div class="alert alert-warning">
                    <h4 class="alert-heading">هل انت متاكد من انك تريد غلق حسابك بشكل نهائي ,بمجرد هذا الاجراء سيتم حذف حسابك بشكل نهائي ولن تستطيع استرجاعه مره اخري
                    </h4>
